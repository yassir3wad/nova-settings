...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        createRequest: function createRequest() {
            return Nova.request().post('/nova-vendor/' + this.resourceName + '/' + this.resourceName, this.createResourceFormData());
        },
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "ul",
        { staticClass: "list-reset flex border-b2 ml-8" },
        _vm._l(_vm.groups, function(group, key, i) {
          return _c("li", { key: "tab" + key, staticClass: "mr-1" }, [
            _c(
              "a",
              {
                staticClass:
                  "bg-white inline-block border-50 border-l border-t border-r rounded-t py-2 px-6 cursor-pointer",
                class:
                  i === _vm.selectedTab
        ...
        _vm.fields
          ? _c(
              ...
              [
                ...
                _vm._v(" "),
                _vm._l(_vm.groups, function(section, key, index) {
                  return _c(
                    "div",
                    {
                      key: index,
                      class: index !== _vm.selectedTab ? "hidden" : ""
                    },
                    _vm._l(_vm.fields, function(field) {
                      return key === field.section
                        ? _c(
                            "div",
                            [
